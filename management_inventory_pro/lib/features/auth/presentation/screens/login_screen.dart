  ...
  Widget build(BuildContext context) {
    return BlocListener<AuthCubit,AuthState>(
      ...
      if(state is AuthSuccess){
        AppSnackBar.showSuccess(context,message:  "${state.user.email} ${LocaleKeys.auth_loginSuccessfully.tr()}");
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              ...
              Wrap( //widgets automatically wrap to the next line (responsive)
